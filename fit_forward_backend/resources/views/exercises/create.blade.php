        ...
        <div class="card-body">
            <form action="{{ route('exercises.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="e.g. Jump Squats" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div class="mb-3">
                    <label for="min" class="form-label">Image</label>
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" name="instructions" class="mt-1"></textarea>
                    @error('instructions')
                        <span class="text-danger text-sm">{{ $message }}</span>
                    @enderror
                </div>
