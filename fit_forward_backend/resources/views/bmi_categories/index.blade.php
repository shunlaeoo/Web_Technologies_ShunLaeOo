...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold">BMI Categories</h4>
        <a href="{{ route('bmi_category.create') }}" class="btn btn-primary">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped text-center" id="bmiCategoryTable">
            ...
            <tbody>
                @foreach($categories as $index => $category)
                    <tr>
                        ...
                        <td>{{ $category->max }}</td>
                        <td>
                            <a href="{{ route('bmi_category.edit', $category->id) }}" 
                            ...
                            <form action="{{ route('bmi_category.destroy', $category->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
